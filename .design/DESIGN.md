...
Read the detailed [product definition](https://github.com/Space-Software-LTDA/owncast/blob/develop/docs/product-definition.md) to learn more.

## 🚢 How to contribute to product design

1. Check out open [issues](https://github.com/Space-Software-LTDA/owncast/issues) here on GitHub (we label them with `needs design`)
...
- Check out our [Contributor Guide](https://owncast.online/help) and
  [Code of Conduct](https://github.com/Space-Software-LTDA/owncast/blob/develop/CODE_OF_CONDUCT.md)
